...
def instagram_upload_video(payload: dict) -> dict:
    ...
    if scheduled:
        ...
        r2_asset = _scheduled_r2_asset_from_payload(payload, video_path) or upload_scheduled_video_asset(video_path, platform="instagram", brand=brand, project=project, r2=r2)
