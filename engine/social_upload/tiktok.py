...
def tiktok_upload_video(payload: dict) -> dict:
    ...
    if scheduled:
        ...
        r2_asset = upload_scheduled_video_asset(video_path, platform="tiktok", brand=brand, project=project, r2=r2)
        queued = schedule_on_vps(
            ...
            tiktok_settings=dict(tiktok_settings) if isinstance(tiktok_settings, dict) else None,
        )
        ...
        return {
            ...
            "monitoring": True,
            "monitoringError": "",
            "message": "Đã upload video lên R2 và chuyển lịch TikTok lên VPS; đến giờ worker mới gọi Zernio đăng ngay.",
        }
