      ...
      <div class="upload-panel" id="uploadPanel" hidden>
        <div class="platform-grid">
          ...
          <section class="platform-card platform-tiktok">
            ...
            <div class="field upload-field compact schedule-row" id="tiktokScheduleRow" hidden><input type="datetime-local" id="tiktokScheduleTime" /><p class="form-note">VPS sẽ đăng TikTok đúng giờ, theo dõi trạng thái Zernio và retry lỗi tạm thời sau 5 phút; không cần giữ app mở.</p></div>
