...
function draftTopic(forceRetime = false) {
  ...
  return {
    ...
    quizQuestionFontFamily: isQuizProject() ? normalizeLabelFontFamily(elements.quizQuestionFont?.value || state.topic.quizQuestionFontFamily) : undefined,
    quizAnswerFontFamily: isQuizProject() ? normalizeLabelFontFamily(elements.quizAnswerFont?.value || state.topic.quizAnswerFontFamily) : undefined,
    quizQuestionColor: isQuizProject() ? (elements.quizQuestionColor?.value || "#ffffff") : undefined,
    quizCountdownColor: isQuizProject() ? (elements.quizCountdownColor?.value || "#ffd166") : undefined,
    quizAnswerColor: isQuizProject() ? (elements.quizAnswerColor?.value || "#ffffff") : undefined,
    quizQuestionSize: isQuizProject() ? Number(elements.quizQuestionSize?.value || state.topic.quizQuestionSize || 7.2) : undefined,
    quizAnswerSize: isQuizProject() ? Number(elements.quizAnswerSize?.value || state.topic.quizAnswerSize || 6.2) : undefined,
